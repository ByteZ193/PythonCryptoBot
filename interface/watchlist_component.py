...
class Watchlist(tk.Frame):
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['exchange'][b_index] = tk.Label(self._table_frame, text=exchange, bg=BG_COLOR,
        ...
        self.body_widgets['bid'][b_index] = tk.Label(self._table_frame, textvariable=self.body_widgets["bid_var"][
            b_index], bg=BG_COLOR, fg=FG_COLOR_2, font=GLOBAL_FONT)
        self.body_widgets['bid'][b_index].grid(row=b_index, column=2)

        self.body_widgets["ask_var"][b_index] = tk.StringVar()
        self.body_widgets['ask'][b_index] = tk.Label(self._table_frame, textvariable=self.body_widgets["ask_var"][
            b_index], bg=BG_COLOR, fg=FG_COLOR_2, font=GLOBAL_FONT)
