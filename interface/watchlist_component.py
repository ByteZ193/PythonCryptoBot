...
class Watchlist(tk.Frame):
    ...
    def _add_symbol(self, symbol: str, exchange: str):
        ...
        self.body_widgets['remove'][b_index] = tk.Button(self._body_frame.sub_frame, text="X", bg="darkred", fg=FG_COLOR, font=GLOBAL_FONT, command=lambda: self._remove_symbol(b_index), width=4)
