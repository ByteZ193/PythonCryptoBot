...
class WorkspaceData:
    def __init__(self):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS strategies (strategy_type TEXT, contract TEXT, ""timeframe TEXT balance_pct REAL, take_profit REAL, stop_loss REAL, extra_params TEXT)")
    ...
    def save(self, table: str, data: typing.List[typing.Tuple]):
        ...
        sql_statement = f"INSERT INFO {table} ({', '.join(columns)}) VALUES ({', '.join(['?'] * len(columns))})"
