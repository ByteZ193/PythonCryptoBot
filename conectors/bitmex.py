...
class BitmexClient:
    def __init__(self, public_key: str, secrect_key: str, tesnet: bool):
        ...
        if tesnet:
            ...
            self._ws_url = "wss://testnet.bitmex.com/realtime"
        else:
            self._base_url = "https://www.bitmex.com"
            self._ws_url = "wss://www.bitmex.com/realtime"
    ...
    def _generate_signature(self, method: str, endpoint: str, expires: str, data: typing.Dict) -> str:
        ...
        return hmac.new(self._secrect_key.encode(), message.encode(), hashlib.sha256).hexdigest()
    ...
    def get_contracts(self) -> typing.Dict[str, Contract]:
        ...
        instruments = self._make_requests("GET", "/api/v1/instrument/active", dict())
    ...
    def get_balances(self) -> typing.Dict[str, Balance]:
        ...
        margin_data = self._make_requests("GET", "/api/v1/user/margin", data)

        balance = dict()

        if margin_data is not None:
            for a in margin_data:
                balance[a['currency']] = Balance(a, "bitmex")
    ...
    def place_order(self, contract: Contract, order_type: str, quantity: int, side: str, price=None,
        ...
        order_status = self._make_requests("POST", "/api/v1/order", data)
    ...
    def cancel_order(self, order_id: str) -> OrderStatus:
        ...
        order_status = self._make_requests("DELETE", "/api/v1/order", data)
    ...
    def get_order_status(self, contract: Contract, order_id: str) -> OrderStatus:
        ...
        order_status = self._make_requests("GET", "/api/v1/order", data)
                ...
                for d in data['data']:
                    ...
                    for key, strat in self.strategies.items():
                        if strat.contract.symbol == symbol:
                            res = strat.parse_trades(float(d['prices']), float(d['size']), ts)
